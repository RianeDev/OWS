    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Char Public API", Version = "v1" });
                ...
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "CharPublicAPI.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                await context.Response.WriteAsync("<b>Characters Online:</b><br><br><i>None</i>");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("./v1/swagger.json", "Char Public API");
            });
